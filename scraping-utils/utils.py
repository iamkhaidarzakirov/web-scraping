...
def add_a_row_to_xlsx(path: str, source: dict, sheet_title: str = 'Sheet1') -> None:
...
def create_proxies_json(proxies_format: str, source_path: str, result_path: str) -> None:
    ...
    — Currently, the function supports to reformat proxies to aiohttp and requests modules formats.
